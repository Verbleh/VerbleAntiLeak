...
public class KillSwitch3
	{
	public static String URL = "A different KillSwitch URL here";
		  ...
		  {
			  {
				    try
				    {
				      ...
				      while ((key = r.readLine()) != null) {
				    	  if(KillSwitchMode.killswitchmode1 = true && key.equalsIgnoreCase("###")) {
				          usable = true;
				        }   else if(KillSwitchMode.killswitchmode2 = true && key.equalsIgnoreCase("##ecsdee")) {
				        	usable = true;
				        }
				        else {
				        	usable = false;
